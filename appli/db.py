...
class Match(Base):
    ...
    def __init__(self, idMatch, lieu, date):
        ...
        equipe1 = get_equipe(idEquipe1)
        equipe2 = Equipe()


     def __str__(self):
        Equipe = new 
        return ("Match : [Equipe 1 : {}, Equipe2 : {}, Lieu : {}, Date : {}, Score equipe 1 : {}, score equipe 2 : {}]".format(Equipe.getEquipeById(self.), self.nom, self.lieu, self.date, 
